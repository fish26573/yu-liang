...
$(document).ready(function(){
    ...
    $.getJSON('../json/Product.json',function(data){
       ...
       console.log( content.substr(0, showChar) + '<span class="moreellipses">' + ellipsestext+ '&nbsp;</span><span class="morecontent"><span>' 
       + content.substr(showChar, content.length-showChar)+ '</span>&nbsp;&nbsp;<a href="" class="morelink">' + moretext + '</a></span>' )
     

        });  

        $(".morelink").click(function(){  
       console.log( $(this).html(moretext) );
